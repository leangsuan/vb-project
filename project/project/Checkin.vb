...
Public Class Checkin
    ...
    Private Sub ButtonAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        If Not (PictureBox1.Image Is Nothing) Then
            sql = "INSERT INTO Roomer(RoomNo, Title, Name, " & _
                   "IDCardNo, BirthDate, Address, Phone, Picture, Status) " & _
                   "VALUES(@room, @title, @name, @idcard, @birth, " & _
                   "@address, @phone, @pic, @status)"
        Else
            sql = "INSERT INTO Roomer(RoomNo, Title, Name, " & _
                  "IDCardNo, BirthDate, Address, Phone, Status) " & _
                  "VALUES(@room, @title, @name, @idcard, @birth, " & _
